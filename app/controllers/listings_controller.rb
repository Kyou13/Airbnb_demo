class ListingsController < ApplicationController
  ...
  before_action :access_deny, only: [:update, :basics, :description, :address, :price, :photos, :calendar, :bankaccount, :publish, :show]
  def index
